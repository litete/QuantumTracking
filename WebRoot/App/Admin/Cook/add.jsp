...
<div class="bjui-pageContent">
	<form action="<%=request.getContextPath()%>/cook/addinfo.do"
				...
				<tbody>
					<tr>
						<td colspan="2"><label class="control-label x100">名&nbsp&nbsp称：</label>
							<input type="text" name="cook_name" size="60"/></td>
					</tr>
					<tr>
						<td colspan="2"><label class="control-label x100">说&nbsp&nbsp明：</label>
							<textarea rows="5" cols="60" name="info" placeholder="厨师相关说明" ></textarea>
						</td>
					</tr>
					<tr>
					...
					<tr>
						<td colspan="2"><label class="control-label x100">提供酒店：</label>
							<input type="text" name="from_gs" size="60" /></td>
					</tr>
					<tr>
