...
<div class="bjui-pageContent">
    <table data-toggle="tablefixed" data-width="100%" data-nowrap="true">
    	...
    	<tr>
    		<!-- localhost -->
    		<td><img src="http://120.27.7.106:80/FiveA/images/${list.img}" width="50px"/></td>
    		<td>${list.studentname}</td>
    		<td>${list.info}</td>
    		<td>${list.from_gs}</td>
    		<td>${list.price}</td>
    		<td>
    			<a href="<%=request.getContextPath()%>/cook/edit.do?id=${list.id}" class="btn btn-default" data-toggle="dialog" data-width="1000" data-height="600" data-id="dialog-mask" data-mask="true">编辑</a>
    			<a href="<%=request.getContextPath()%>/cook/delete.do?id=${list.id}" class="btn btn-red" data-toggle="doajax" data-confirm-msg="确定要删除吗？">删除</a>
    		</td>
    	</tr>
    	</c:forEach>
    	</tbody>
