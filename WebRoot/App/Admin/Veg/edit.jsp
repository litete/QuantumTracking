...
<div class="bjui-pageContent">
	<form action="<%=request.getContextPath()%>/veg/update.do"
				...
				<tbody>
					<tr>
						<td colspan="2"><label class="control-label x100">名&nbsp&nbsp称：</label>
							<input type="text" name="name" size="60" value="${info.name}"/></td>
					</tr>
					<tr>
					...
					<tr>
						<td colspan="2"><label class="control-label x100">说&nbsp&nbsp明：</label>
							<textarea rows="5" cols="60" name="info" placeholder="蔬菜相关说明">${info.info}</textarea>
						</td>
					</tr>
					<tr>
