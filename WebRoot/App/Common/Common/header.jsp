...
<header id="bjui-header">
	<div class="bjui-navbar-header">
		...
		<a class="bjui-navbar-logo" href="<%=request.getContextPath()%>"><img
			src="<%=request.getContextPath()%>/App/OA/Public/Img/logo.png"></a>
	</div>
	<nav id="bjui-navbar-collapse">
		<ul class="bjui-navbar-right">
			...
			<li class="dropdown"><a href="#" class="dropdown-toggle"
				data-toggle="dropdown">切换系统 <span class="caret"></span></a>
				<ul class="dropdown-menu" role="menu">
					<li><a href="/FiveA/AppWeb/index.jsp" target="_blank"><i
							class="fa fa-flag"></i> 手机网站</a></li>
					<li class="divider"></li>
					<li><a href="" target="_blank"><i
							class="fa fa-flag"></i> 网站首页</a></li>
					<li class="divider"></li>
			...
			<li class="dropdown"><a href="#" class="dropdown-toggle"
				...
				<ul class="dropdown-menu" role="menu">
					<li><a href="{:U('Admin/User/modifyPwd')}"
						data-toggle="dialog" data-id="changepwd_page" data-mask="true"
						data-width="400" data-height="260">&nbsp;<span
							class="fa fa-lock"></span> 修改密码
					</a></li>
					<li><a
						href="{:U('Admin/UserDangjian/edit?uid='.getSession('myInfo.uid'))}"
						data-toggle="dialog" data-id="changepwd_page" data-mask="true"
						data-width="1000" data-height="600">&nbsp;<span
							class="fa fa-user"></span> 我的资料
					</a></li>
					<!--li><a href="{:U('Admin/Index/cache')}" data-toggle="navtab">&nbsp;<span class="fa fa-trash"></span> 清理缓存</a></li-->
					<li class="divider"></li>
					<li><a href="<%=request.getContextPath()%>/user/loginOut.do" class="red">&nbsp;<span
							class="fa fa-power-off"></span> 注销登陆
					</a></li>
				</ul></li>
			<li class="dropdown"><a href="#"
				...
				<ul class="dropdown-menu" role="menu" id="bjui-themes">
					...
					<li class="active"><a href="javascript:;" class="theme_purple"
					...
					<li><a href="javascript:;" class="theme_blue"
						data-toggle="theme" data-theme="blue">&nbsp;<i
							class="fa fa-tree"></i> 青出于蓝
					</a></li>
					<li><a href="javascript:;" class="theme_red"
						data-toggle="theme" data-theme="red">&nbsp;<i
							class="fa fa-tree"></i> 红红火火
					</a></li>
