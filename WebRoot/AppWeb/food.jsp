	...
	<div id="page">
		...
		<div class="bannerPane banner-img3">
			...
			<div class="s-banner-content">
				...
				<i class="fa fa-th-list"></i> 美食街
			</div>
		</div>
		<div id="content">
			<c:forEach var="list" items="${list}">
				<article>
					<a  href="<%=basePath%>veg/info.do?id=${list.id}">
						...
						<div class="prod-pricePane">
							 <span class="current-price">${list.price}</span>
		...
		<nav id="menu">
			<ul>
				...
				<li class="Selected"><a href="<%=basePath%>veg/allAppWeb.do"> <i
						class="fa fa-th-list"></i>美食街
				</a></li>
